...
ResponsiveDatatablesHelper.prototype.respond = function() {
  ...
  if (!this.skipNextWindowsWidthChange) {
    ...
    if (this.lastBreakpoint.length === 0 && newColumnsToHide.length) {
      ...
      var d1 = this.difference(this.columnsHiddenIndexes, newColumnsToHide)
        .length;
      var d2 = this.difference(newColumnsToHide, this.columnsHiddenIndexes)
        .length;
...
ResponsiveDatatablesHelper.prototype.showRowDetail = function(
  ...
  for (
    ...
    if (
      !responsiveDatatablesHelperInstance.options.hideEmptyColumnsInRowDetail ||
