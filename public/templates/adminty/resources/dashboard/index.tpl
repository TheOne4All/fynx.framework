                ...
                <div class="col-xl-9 col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <span class="text-muted">For more details about usage, please refer <a href="https://www.amcharts.com/online-store/" target="_blank">amCharts</a>
                                licences.</span>
                        ...
                        <div class="card-block">
                            <div class="row m-b-25">
                                <div class="col-auto p-r-0">
                                    <div class="u-img">
                                        <img src="<?= DIR['media'] ?>breadcrumb-bg.jpg" alt="user image" class="img-radius cover-img">
                                        <img src="<?= DIR['media'] ?>avatar-2.jpg" alt="user image" class="img-radius profile-img">
                                    </div>
                                </div>
                                <div class="col">
                                                    ...
                                                    <tr>
                                                        <td class="b-none">
                                                            <a href="#!" class="align-middle">
                                                                <img src="<?= DIR['media'] ?>avatar-2.jpg" alt="user image" class="img-radius img-40 align-top m-r-15">
                        ...
                        <div class="row m-l-0 m-r-0">
                            <div class="col-sm-4 bg-c-lite-green user-profile">
                                <div class="card-block text-center text-white">
                                    <div class="m-b-25">
                                        <img src="<?= DIR['media'] ?>avatar-4.jpg" class="img-radius" alt="User-Profile-Image">
                                    </div>
                                ...
                                <div class="card-block">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <h6 class="text-muted f-w-400"><a href="..\..\..\cdn-cgi\l\email-protection.htm" class="__cf_email__" data-cfemail="3a505f54437a5d575b535614595557">[email&#160;protected]</a>
                                            </h6>
                                        </div>
                                        <div class="col-sm-6">
                                    ...
                                    <ul class="social-link list-unstyled m-t-40 m-b-10">
                                        ...
                                        <li><a href="#!" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="instagram"><i class="feather icon-instagram instagram" aria-hidden="true"></i></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
