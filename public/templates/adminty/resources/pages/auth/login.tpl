...
<form class="md-float-material form-material" action="<?= BASE['url'] ?>dashboard/index">
    ...
    <div class="auth-box card">
        <div class="card-block">
            ...
            <div class="row m-t-25 text-left">
                <div class="col-12">
                    ...
                    <div class="forgot-phone text-right f-right">
                        <a href="<?= BASE['url'] ?>auth/reset" class="text-right f-w-600"> Forgot Password?</a>
                    </div>
                </div>
            </div>
            ...
            <p class="text-inverse text-left">Don't have an account?<a href="<?= BASE['url'] ?>auth/signup"> <b class="f-w-600">Register here </b></a>for free!</p>
        </div>
    </div>
</form>