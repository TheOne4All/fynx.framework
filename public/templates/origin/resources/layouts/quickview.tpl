<!-- toggle between the OPEN class to slide in the right menu sidebar -->
<div id="quickview" class="quickview-wrapper" data-pages="quickview">
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li>
            <a href="#quickview-alerts" data-target="#quickview-alerts" data-toggle="tab" role="tab" class=""
                aria-selected="false">Alerts</a>
        </li>
        <li class="">
            <a href="#quickview-chat" data-toggle="tab" role="tab" class="active show" aria-selected="false">Chat</a>
        </li>
    </ul>
    <a class="btn-link quickview-toggle" data-toggle-element="#quickview" data-toggle="quickview"><i
            class="feather icon-x fs-16"></i></a>
            ...
            <div class="view-port clearfix quickview-notes" id="note-views">
                ...
                <div class="view list" id="quick-note-list">
                    <div class="toolbar clearfix">
                        <ul class="pull-right ">
                            <li>
                                <a href="#" class="delete-note-link"><i class="feather icon-trash-2"></i></a>
                            </li>
                            <li>
                                <a href="#" class="new-note-link" data-navigate="view" data-view-port="#note-views"
                                    data-view-animation="push"><i class="feather icon-plus"></i></a>
                            </li>
                        </ul>
                        <button class="btn-remove-notes btn btn-xs btn-block hide"><i class="feather icon-x"></i>
                            Delete</button>
                    </div>
                    <ul>
                        ...
                        <li data-noteid="1">
                            ...
                            <div class="right pull-right">
                                ...
                                <a href="#" data-navigate="view" data-view-port="#note-views"
                                    data-view-animation="push"><i class="feather icon-chevron-right fw-400"></i></a>
                        ...
                        <li data-noteid="2">
                            ...
                            <div class="right pull-right">
                                ...
                                <span class="date">12/12/14</span>
                                <a href="#"><i class="feather icon-chevron-right"></i></a>
                ...
                <div class="view note" id="quick-note">
                    <div>
                        <ul class="toolbar">
                            ...
                            <li><a href="#" data-action="Bold" class="fs-12"><i class="feather icon-bold"></i></a>
                            </li>
                            <li><a href="#" data-action="Italic" class="fs-12"><i class="feather icon-italic"></i></a>
                            </li>
                            <li><a href="#" class="fs-12"><i class="feather icon-link"></i></a>
                            </li>
                        </ul>
                        <div class="body">
                            <div>
                    ...
                    <div data-init-list-view="ioslist" class="list-view boreded no-top-border">
                        ...
                        <div class="scroll-wrapper list-view-wrapper" style="position: absolute;">
                            <div class="list-view-wrapper scroll-content" data-ios="false"
                                style="height: 716.4px; margin-bottom: 0px; margin-right: 0px; max-height: none;">
                                    ...
                                    <ul>
                                        ...
                                        <li class="alert-list">
                                            ...
                                            <a href="javascript:;" class="align-items-center" data-navigate="view"
                                                data-view-port="#chat" data-view-animation="push-parrallax">
                                                <p class="">
                                                    <span class="text-warning fs-10"><i class="feather icon-alert-circle"></i></span>
                                                </p>
                                    ...
                                    <ul>
                                        ...
                                        <li class="alert-list">
                                            ...
                                            <a href="#" class="p-t-10 p-b-10 align-items-center" data-navigate="view"
                                                data-view-port="#chat" data-view-animation="push-parrallax">
                                                <p class="">
                                                    <span class="text-danger fs-10"><i class="feather icon-alert-circle"></i></span>
                                                </p>
                                                <p class="col overflow-ellipsis fs-12 p-l-10">
                            ...
                            <div class="scroll-element scroll-y" style="">
                                <div class="scroll-element_outer">
                                    <div class="scroll-element_size"></div>
                                    <div class="scroll-element_track"></div>
                                    <div class="scroll-bar" style="height: 95px;"></div>
                                </div>
                            </div> -->
                        </div>
                    </div>
                ...
                <div class="view bg-white">
                    ...
                    <div data-init-list-view="ioslist" class="list-view boreded no-top-border">
                        <h2 class="list-view-fake-header">
                            a</h2>
                        <div class="scroll-wrapper list-view-wrapper" style="position: absolute;">
                            <div class="scroll-content scroll-scrolly_visible" data-ios="false"
                    ...
                    <div class="chat-inner" id="my-conversation">
                        ...
                        <div class="message clearfix">
                            <div class="profile-img-wrapper m-t-5 inline">
                                <img class="col-top" width="30" height="30" src="assets/img/profiles/avatar_small2x.jpg"
                    ...
                    <div class="b-t b-grey bg-white clearfix p-l-10 p-r-10">
                        <div class="row">
                            <div class="col-1 p-t-15">
                                <a href="#" class="link text-master"><i class="feather icon-plus-circle"></i></a>
                            </div>
