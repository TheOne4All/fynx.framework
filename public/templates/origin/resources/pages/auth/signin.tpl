...
<div class="login-wrapper">
    <div class="bg-pic" style="background-image: url(<?= LINK ?>media/auth/bg.jpg)">
        <div class="gradient-black image-responsive-width"></div>
        <div class="bg-caption pull-bottom text-white p-l-30 m-b-20">
            <h2 class="semi-bold text-white">Learning by Doing With <?= APP_NAME ?></h2>
    ...
    <div class="login-container bg-master-lightest">
        <div class="m-t-30 m-l-15 p-l-15 m-r-15 p-r-15">
            ...
            <form id="form-login" class="p-t-10" role="form" action="<?= LINK ?>dashboard/index"
