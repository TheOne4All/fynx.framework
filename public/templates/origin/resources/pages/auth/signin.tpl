...
<div class="login-wrapper">
    <div class="bg-pic" style="background-image: url(../media/auth/bg.jpg)">
        <div class="gradient-black image-responsive-width"></div>
        <div class="bg-caption pull-bottom text-white p-l-30 m-b-20">
            <h2 class="semi-bold text-white">Learning by Doing With <?= FYNX_APP['name'] ?></h2>
            <p class="small">All Rights Reserved © 2013-2020 <?= FYNX_APP['name'] ?> Team.</p>
        </div>
    </div>

    <div class="login-container bg-master-lightest">
        <div class="m-t-30 m-l-15 p-l-15 m-r-15 p-r-15">
            <img src="<?= FYNX_LOGO['dark'] ?>" alt="logo" height="20">
            <h3>Sign-In to Your Account</h3>
            <p>Enjoy the best of our educational services as you Sign-in to your account</p>

            <form id="form-login" class="p-t-10" role="form" method="POST" action="<?= FYNX_PUBLIC['url'] ?>auth/verify"
                ...
                <div class="row m-t-20 m-b-10">
                    ...
                    <div class="col-6 text-right">
                        <a href="<?= FYNX_PUBLIC['url'] ?>auth/reset" class="text-info small">Forget Password?</a>
                    </div>
                </div>
                ...
                <div class="m-r-30 m-t-10 p-b-20 clearfix">
                    <div class="col-sm-12 no-padding no-padding d-flex align-items-center justify-content-center">
                        <p class="small no-margin flex-1">Sign-up an account <a
                                href="<?= FYNX_PUBLIC['url'] ?>auth/signup"><b>Here</b></a>. If
                            you have a facebook
                            account,
                            log
                            into
