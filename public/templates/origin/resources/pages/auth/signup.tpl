...
<div class="register-container p-t-30  p-r-30  p-l-30  p-b-30">
    <div class="d-flex justify-content-center flex-column full-height ">
        <img src="<?= FYNX_LOGO['dark'] ?>" alt="logo" width="100" height="">
        ...
        <form id="form-register" class="p-t-10" role="form" method="POST"
            action="<?= FYNX_PUBLIC['url'] ?>auth/register" novalidate="novalidate">
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="row m-t-10 m-b-10">
                <div class="col-6">
                    <small>I agree to <a href="#" class="text-info"><?= FYNX_APP['name'] ?> Terms</a></small>
                </div>
                <div class="col-6 text-right">
                    <small>Back to <a href="<?= FYNX_PUBLIC['url'] ?>auth/signin" class="text-info">Sign-In</a></small>
                </div>
            </div>
