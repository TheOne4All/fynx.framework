...
<form class="md-float-material form-material">
    ...
    <div class="auth-box card">
        <div class="card-block">
            ...
            <p class="f-w-600 text-right">Back to <a href="<?=LINK?>auth/login">Login.</a></p>
            <hr>
            <div class="row">
                <div class="col-md-10">
                    <!-- <p class="text-inverse text-left m-b-0">Thank you.</p> -->
                    <p class="text-inverse text-left"><a href="<?=LINK?>pages/index"><b class="f-w-600">Back to website</b></a></p>
                </div>
                <!-- <div class="col-md-2">
                    <img src="<?=LINK?>media/Logo-small-bottom.png" alt="logo.png">
