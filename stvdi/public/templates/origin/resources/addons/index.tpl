...
<div class="content ">
    ...
    <div class="jumbotron" data-pages="parallax">
        <div class=" container-fluid   container-fixed-sm sm-p-l-0 sm-p-r-0">
            <div class="inner" style="transform: translateY(0px); opacity: 1;">

                <div class="row p-b-30 sm-p-b-0">
                    ...
                    <div class="col-xl-5 col-lg-6 ">
                        <div class="card card-transparent sm-no-margin">
                            <div class="card-header sm-p-t-15 sm-p-l-15">
    ...
    <div class="container-fluid container-fixed-sm bg-white">
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-borderless p-b-10">
                    <ul class="nav nav-tabs nav-tabs-simple d-none d-md-flex d-lg-flex d-xl-flex" role="tablist"
                        ...
                        <li class="nav-item">
                            <a href="#" data-toggle="tab" role="tab" data-target="#tab2FollowUs">Featured Add-ons</a>
                        </li>
                        <li class="nav-item">
                            <a href="#" data-toggle="tab" role="tab" data-target="#tab2Inspire">Add-on Store</a>
                        </li>
                    </ul>

                    <div class="tab-content m-t-20 sm-m-t-5">
