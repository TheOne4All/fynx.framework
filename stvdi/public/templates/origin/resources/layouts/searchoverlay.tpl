...
<div class="overlay hide" data-pages="search">
    ...
    <div class="overlay-content has-results m-t-30 sm-p-l-15 sm-p-r-15 sm-m-t-15">

        <div class="container-fluid">

            <img class="overlay-brand" src="<?= MEDIA ?>b_logo.png" alt="logo" data-src="<?= MEDIA ?>b_logo.png"
                data-src-retina="<?= MEDIA ?>b_logo.png" width="78" height="22">
...
<!-- <script type="text/javascript" src="<?= LINK ?>templates/origin/plugins/popper.min.js"></script> -->
